...
// node_modules/ipad-cursor/index.mjs
var ready = false;
var observer = null;
var cursorEle = null;
...
var styleTag = null;
var latestCursorStyle = {};
var mousedownStyleRecover = {};
var position = { x: 0, y: 0 };
var isServer = typeof document === "undefined";
var registeredNodeSet = /* @__PURE__ */ new Set();
var eventMap = /* @__PURE__ */ new Map();
...
var Utils = class _Utils {
  ...
  static mergeDeep(obj, ...sources) {
    ...
    if (this.isMergebleObject(obj) && this.isMergebleObject(source)) {
      _Utils.objectKeys(source).forEach((key) => {
...
function registerTextNode(node) {
  ...
  function toggleTextActive(active) {
    isTextActive = !!active;
    cursorEle && (active ? cursorEle.classList.add("text-active") : cursorEle.classList.remove("text-active"));
  }
...
function registerBlockNode(_node) {
  ...
  function toggleBlockActive(active) {
    ...
    cursorEle && (active ? cursorEle.classList.add("block-active") : cursorEle.classList.remove("block-active"));
  }
  function onBlockEnter() {
    var _a, _b, _c;
    cursorEle && cursorEle.classList.toggle("lighting--on", !!config.enableLighting);
    ...
    if (styleToUpdate.durationPosition === void 0) {
      styleToUpdate.durationPosition = (_b = styleToUpdate.durationBase) !== null && _b !== void 0 ? _b : (_c = config.normalStyle) === null || _c === void 0 ? void 0 : _c.durationBase;
    }
...
//# sourceMappingURL=ipad-cursor.js.map
